...
describe("pickProject", () => {
  ...
  it("falls back to the first non-personal project", () => expect(pickProject(projects, "gone")).toBe("a"));
...
describe("parsePanelRoute", () => {
  ...
  it("reads a bare project", () => expect(parsePanelRoute("a")).toEqual({ projectId: "a", feature: null }));
  it("handles the root", () => expect(parsePanelRoute("")).toEqual({ projectId: null, feature: null }));
});
